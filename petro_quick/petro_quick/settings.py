"""
Django settings for petro_quick project.
...
SECRET_KEY = 'django-insecure-0+ch1i(=1b%f0qh7rc0$m_cq@&u83yholp28h1(d0ce*3q@n=v'
...
WSGI_APPLICATION = 'petro_quick.wsgi.application'
...
UNFOLD = {
    "SITE_HEADER": _("PetroQuick"),
    "SITE_TITLE": _("PetroQuick"),
    "SITE_SYMBOL": "PetroQuick",
    "SITE_ICON": {
